...
from chanlun_trader.alpha_strategies_round2 import ALL_STRATEGIES_R2 as ALL_STRATEGIES
...
def main() -> None:
    ...
    cfg["__index_ma60__"] = pd.Series(bench["close"].rolling(60).mean().to_numpy(), index=bench["date"].astype("int64"))
    ...
    ledger_path = Path("experiments/research_ledger_round2.csv")
