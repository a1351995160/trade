...
P3_C_STATUS = BLOCKED_AT_MATERIALIZATION (真实冻结后的正向物化用例失败，核心合同方案待批准)
...
P3-B 的历史实现与验证范围见 [PHASE3B_RESTART_RECOVERY_V1.md](PHASE3B_RESTART_RECOVERY_V1.md)。当前 P3-C 的失败证据、核心合同衔接方案与未验证范围见 [PHASE3C_LIFECYCLE_CERTIFICATION_V1.md](PHASE3C_LIFECYCLE_CERTIFICATION_V1.md)。P3-C 尚未通过；不合并 main，不启动 R1/R2，Phase 3 不宣告关闭。
