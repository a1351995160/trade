...
2026-09-26 已新增[正式评审流程与实际校准结果](FORMAL_STRATEGY_ASSESSMENT_V1.md)。评审入口、费用压力账户和证据核验已接入；固定完整校准有 44/81 项支持范围检查失败，因此仍没有正式合格策略。正式 Paper 的条件分支只接受权威评审，首版限定单策略及原评审证券、资金规模；组合工程观察不因此变成组合有效性证明。
