...
[V2方法验收](FORMAL_STATISTICS_V2.md)已保留本页所有V1失败事实，采用固定8段均值检验并完成新种子147,456条校准和完整重放：126项误判门、2项功效门全部通过。旧报告仍按旧方法读取，预算不重置。真实策略资格仍为0；当前下一步是真实账户收益过程适用性与独立证据审查，不能由合成校准直接进入正式Paper。
