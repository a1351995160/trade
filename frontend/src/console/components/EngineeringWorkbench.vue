...
type View = { context_hash: string; actions_allowed: boolean; qualified_strategy_count: number; frozen_input_count: number; account: { cash: number; equity: number }; sources: { candidate_id: string; sessions: number[] }[]; paper: Record<string, Replay> }
