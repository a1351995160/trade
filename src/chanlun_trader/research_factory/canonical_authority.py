...
class CanonicalAuthorityContractV1:
    ...
    principles: tuple[str, ...] = (
        ...
        "Only one identity-matching DurableFrozenCandidateContractV1 that passes from_dict and provider_candidate_payload is executable Candidate authority.",
    ...
    entries: tuple[CanonicalAuthorityEntryV1, ...] = (
        ...
        CanonicalAuthorityEntryV1(
            ...
            ("daemon contract cache", "orchestrator snapshot", "Structural provider input"),
