...
STATE_DISPLAY_NAMES: dict[str, str] = {
    ...
    "EXECUTABLE_MATERIALIZATION_PREVIEW_READY": "执行合同预览已就绪，等待人工确认",
    "EXECUTABLE_MATERIALIZATION_RECOVERY_REQUIRED": "执行合同等待崩溃恢复",
    "EXECUTABLE_MATERIALIZATION_CONFIRMATION_MISSING": "执行合同缺少人工确认",
    "EXECUTABLE_CONTRACT_INVALID": "执行合同无效",
...
ACTION_DISPLAY_NAMES: dict[str, str] = {
    ...
    "HUMAN_CONFIRM_EXECUTABLE_MATERIALIZATION": "人工确认执行合同",
    "RECOVER_EXECUTABLE_MATERIALIZATION": "恢复已确认的执行合同",
